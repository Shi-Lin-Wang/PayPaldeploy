<?php
    ...
    $result2 = mysqli_query($connection,$sql_acc);
	  if($result->num_rows > 0 || $result2->num_rows > 0){
        setcookie("signError","true",time()+(300),"/wtlab108","140.127.74.191");
        ...
        echo $sql;
		    mysqli_query($connection, $sql);
				...
				setcookie("signError","false",time()+(300),"/wtlab108","140.127.74.191");
        setcookie("seed","$account",time()+(300),"/wtlab108","140.127.74.191");
		    header("Location:http://140.127.74.191:3000/seed/"."$account");
    }
