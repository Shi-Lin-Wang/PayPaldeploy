<?php
    ...
    if(checkAccount($account,$password,$connection)){
        ...
        setcookie("failToLogin",null,time()-360000,"/wtlab108","140.127.74.191");
		header("Location:https://140.127.74.191/wtlab108/testChing/chooseShop.html");
        //到學校改成這個
        ...
        $failToLogin += 1;
        setcookie("failToLogin",$failToLogin,time()+(300),"/wtlab108","140.127.74.191");
        header("Location:https://140.127.74.191/wtlab108/index.html");
        //到學校改成這個
    ...
    function packageToken($account){
        ...
        setcookie("token",$token,time()+(3600),"/wtlab108","140.127.74.191",0,0);
        //到學校改成這個
