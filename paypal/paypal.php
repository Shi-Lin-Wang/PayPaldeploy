...
$DBname = 'wtlab108';//資料庫名稱
    ...
    mysqli_query($connection, $sql);
    header("Location:https://140.127.74.191/wtlab108/orderWithIOTA/paypal/paypal.php");
...
$redirectUrls->setReturnUrl("https://140.127.74.191/wtlab108/orderWithIOTA/paypal/pay.php?success=true")
//$redirectUrls->setReturnUrl("https://www.sandbox.paypal.com/cgi-bin/webscr")
    ->setCancelUrl("https://140.127.74.191/wtlab108/index.html");
$payment = new Payment(); 
